# Fibril simulation: truncated insulin fibril (3-mer)

This directory contains molecular dynamics simulations of a **truncated insulin fibril consisting of three fibril segments (3-mer)**. The fibril fragment is **capped at the termini** to avoid artificial end effects caused by truncation of the protofilament.
