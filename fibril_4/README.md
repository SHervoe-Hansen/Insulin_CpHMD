# Fibril simulation: truncated insulin fibril (4-mer)

This directory contains molecular dynamics simulations of a **truncated insulin fibril consisting of four fibril segments (4-mer)**. The fibril fragment is **capped at the termini** to avoid artificial end effects caused by truncation of the protofilament.
