# Fibril simulation: truncated insulin fibril (2-mer)

This directory contains molecular dynamics simulations of a **truncated insulin fibril consisting of two fibril segments (2-mer)**. The fibril fragment is **capped at the termini** to avoid artificial end effects caused by truncation of the protofilament.
